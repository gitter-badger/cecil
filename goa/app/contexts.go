...
func NewMailerConfigAccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*MailerConfigAccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewNewAPITokenAccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*NewAPITokenAccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewRemoveMailerAccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*RemoveMailerAccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewRemoveSlackAccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*RemoveSlackAccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewSlackConfigAccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*SlackConfigAccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewVerifyAccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*VerifyAccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewAddCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*AddCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewAddWhitelistedOwnerCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*AddWhitelistedOwnerCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewDeleteWhitelistedOwnerCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*DeleteWhitelistedOwnerCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewDownloadInitialSetupTemplateCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*DownloadInitialSetupTemplateCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewDownloadRegionSetupTemplateCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*DownloadRegionSetupTemplateCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewListRegionsCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*ListRegionsCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewListWhitelistedOwnersCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*ListWhitelistedOwnersCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewShowCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*ShowCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewSubscribeSNSToSQSCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*SubscribeSNSToSQSCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewUpdateCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*UpdateCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewUpdateWhitelistedOwnerCloudaccountContext(ctx context.Context, r *http.Request, service *goa.Service) (*UpdateWhitelistedOwnerCloudaccountContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewActionsEmailActionContext(ctx context.Context, r *http.Request, service *goa.Service) (*ActionsEmailActionContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewDeleteFromDBLeasesContext(ctx context.Context, r *http.Request, service *goa.Service) (*DeleteFromDBLeasesContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewListLeasesForAccountLeasesContext(ctx context.Context, r *http.Request, service *goa.Service) (*ListLeasesForAccountLeasesContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewListLeasesForCloudaccountLeasesContext(ctx context.Context, r *http.Request, service *goa.Service) (*ListLeasesForCloudaccountLeasesContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewSetExpiryLeasesContext(ctx context.Context, r *http.Request, service *goa.Service) (*SetExpiryLeasesContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewShowLeasesContext(ctx context.Context, r *http.Request, service *goa.Service) (*ShowLeasesContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewTerminateLeasesContext(ctx context.Context, r *http.Request, service *goa.Service) (*TerminateLeasesContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
// OrderInstancesReportReportContext provides the report orderInstancesReport action context.
type OrderInstancesReportReportContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
	AccountID      int
...
// NewOrderInstancesReportReportContext parses the incoming request URL and body, performs validations and creates the
// context used by the report controller orderInstancesReport action.
func NewOrderInstancesReportReportContext(ctx context.Context, r *http.Request, service *goa.Service) (*OrderInstancesReportReportContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := OrderInstancesReportReportContext{Context: ctx, ResponseData: resp, RequestData: req}
	paramAccountID := req.Params["account_id"]
	if len(paramAccountID) > 0 {
		rawAccountID := paramAccountID[0]
		if accountID, err2 := strconv.Atoi(rawAccountID); err2 == nil {
...
type orderInstancesReportReportPayload struct {
	MinimumLeaseAge *string  `form:"minimum_lease_age,omitempty" json:"minimum_lease_age,omitempty" xml:"minimum_lease_age,omitempty"`
	Recipients      []string `form:"recipients,omitempty" json:"recipients,omitempty" xml:"recipients,omitempty"`
}

// Validate runs the validation rules defined in the design.
func (payload *orderInstancesReportReportPayload) Validate() (err error) {
	if payload.MinimumLeaseAge == nil {
		err = goa.MergeErrors(err, goa.MissingAttributeError(`raw`, "minimum_lease_age"))
	}
	return
}

// Publicize creates OrderInstancesReportReportPayload from orderInstancesReportReportPayload
func (payload *orderInstancesReportReportPayload) Publicize() *OrderInstancesReportReportPayload {
	var pub OrderInstancesReportReportPayload
	if payload.MinimumLeaseAge != nil {
		pub.MinimumLeaseAge = *payload.MinimumLeaseAge
	}
	if payload.Recipients != nil {
		pub.Recipients = payload.Recipients
	}
	return &pub
}
...
// ShowReportReportContext provides the report showReport action context.
type ShowReportReportContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
	AccountID      int
...
// NewShowReportReportContext parses the incoming request URL and body, performs validations and creates the
// context used by the report controller showReport action.
func NewShowReportReportContext(ctx context.Context, r *http.Request, service *goa.Service) (*ShowReportReportContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := ShowReportReportContext{Context: ctx, ResponseData: resp, RequestData: req}
	paramAccountID := req.Params["account_id"]
	if len(paramAccountID) > 0 {
		rawAccountID := paramAccountID[0]
		if accountID, err2 := strconv.Atoi(rawAccountID); err2 == nil {
	...
	paramReportUUID := req.Params["report_uuid"]
	if len(paramReportUUID) > 0 {
		rawReportUUID := paramReportUUID[0]
		if reportUUID, err2 := uuid.FromString(rawReportUUID); err2 == nil {
			rctx.ReportUUID = reportUUID
		} else {
			err = goa.MergeErrors(err, goa.InvalidParamTypeError("report_uuid", rawReportUUID, "uuid"))
		}
	}
	return &rctx, err
}
...
// OK sends a HTTP response with status code 200.
func (ctx *ShowReportReportContext) OK(resp []byte) error {
	ctx.ResponseData.Header().Set("Content-Type", "application/json")
	ctx.ResponseData.WriteHeader(200)
	_, err := ctx.ResponseData.Write(resp)
	return err
...
func NewShowRootContext(ctx context.Context, r *http.Request, service *goa.Service) (*ShowRootContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
