...
// instancesReportOrderInputPayload user type.
type instancesReportOrderInputPayload struct {
...
// Publicize creates InstancesReportOrderInputPayload from instancesReportOrderInputPayload
func (ut *instancesReportOrderInputPayload) Publicize() *InstancesReportOrderInputPayload {
	var pub InstancesReportOrderInputPayload
	if ut.MinimumLeaseAge != nil {
		pub.MinimumLeaseAge = ut.MinimumLeaseAge
	}
	if ut.Recipients != nil {
		pub.Recipients = ut.Recipients
	}
	return &pub
}
