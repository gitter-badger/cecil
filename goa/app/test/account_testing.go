...
func NewAPITokenAccountOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController, accountID int, payload *app.NewAPITokenAccountPayload) http.ResponseWriter {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "AccountTest"), rw, req, prms)
	newAPITokenCtx, err := app.NewNewAPITokenAccountContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
	...
	// Perform action
	err = ctrl.NewAPIToken(newAPITokenCtx)
...
func RemoveMailerAccountOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.AccountController, accountID int) http.ResponseWriter {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "AccountTest"), rw, req, prms)
	removeMailerCtx, err := app.NewRemoveMailerAccountContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}

	// Perform action
	err = ctrl.RemoveMailer(removeMailerCtx)
